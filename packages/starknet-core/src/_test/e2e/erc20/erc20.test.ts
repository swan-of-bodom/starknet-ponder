...
// TODO: This e2e test requires real ERC20 transfers on devnet.
// The simulate.ts functions create mock data but the ponder indexer
// queries the RPC for real events which won't match the mock data.
// Skip until we have actual contract interactions on devnet.
test.skip(
  "erc20",
  async () => {
