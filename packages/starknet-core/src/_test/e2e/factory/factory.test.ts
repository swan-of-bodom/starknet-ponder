...
// TODO: This e2e test requires deploying real Cairo contracts on devnet.
// The simulate.ts functions create mock data but don't deploy actual contracts,
// so the ponder indexer won't find matching events from the RPC.
// Skip until we have compiled Cairo contracts for testing.
test.skip(
  "factory",
  async () => {
