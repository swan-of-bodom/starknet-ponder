...
// TODO: These tests are for EVM event decoding which uses topics/data format.
// Starknet events use a different format (keys/data with felt252 values).
// Skip until we implement Starknet-specific event decoding tests.
test.skip("named args: Transfer(address,address,uint256)", () => {
...
test.skip("named args with a missing name: Transfer(address,address,uint256)", () => {
  const event = decodeEventLog({
    abiItem: {
      inputs: [
        {
...
test.skip("unnamed args: Transfer(address,address,uint256)", () => {
  const event = decodeEventLog({
    abiItem: {
      inputs: [
        {
...
test.skip("unnamed args: mixed ordering of indexed args", () => {
  const event = decodeEventLog({
    abiItem: {
      inputs: [
        {
...
test.skip("args: data – named (address,address,uint256)", () => {
  const event = decodeEventLog({
    abiItem: {
      inputs: [
        {
...
test.skip("args: data – unnamed (address,address,uint256)", () => {
  const event = decodeEventLog({
    abiItem: {
      inputs: [
        {
...
test.skip("named: topics + event params mismatch", () => {
  expect(() =>
    decodeEventLog({
      abiItem: {
        inputs: [
...
test.skip("unnamed: topics + event params mismatch", () => {
  expect(() =>
    decodeEventLog({
      abiItem: {
        inputs: [
...
test.skip("data + event params mismatch", () => {
  expect(() =>
    decodeEventLog({
      abiItem: {
        anonymous: false,
...
test.skip("errors: invalid data size", () => {
  expect(() =>
    decodeEventLog({
      abiItem: {
        inputs: [
