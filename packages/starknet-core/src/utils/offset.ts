...
export function getBytesConsumedByParam(param: AbiParameter): number {
  ...
  // For Starknet: felt252, u8, u16, u32, u64, u128, u256, etc. are also 32 bytes
  if (
    param.type === "string" ||
    ...
    param.type === "bool" ||
    param.type === "felt252" ||
    param.type.startsWith("u") || // u8, u16, u32, u64, u128, u256
    param.type.startsWith("i")    // i8, i16, i32, i64, i128
  ) {
    return 32;
  }
