...
test("getChildAddresses()", async (context) => {
  ...
  expect(addresses).toMatchInlineSnapshot(`
    Map {
      "0x03b17ca0734e49b438a4aa6f78fc06380f39b9d5e94a1ed9c152722bb99098e2" => 0,
    }
  `);
});
...
test("getChildAddresses() distinct", async (context) => {
  ...
  expect(addresses).toMatchInlineSnapshot(`
    Map {
      "0x026bb89e210395f8b45c4a44bac0fdaba89bd36f938bec9fc4c7356d75e83922" => 0,
    }
  `);
});
