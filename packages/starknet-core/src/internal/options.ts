...
// NOTE: Improve:
//       - Reduced factoryAddressCountThreshold from 1000 to 1 until new RPC spec gets updated to 
//         include multiple address filters. SEE: https://github.com/starkware-libs/starknet-specs/pull/351
//         This makes indexing child contracts very slow, but avoids making 1 rpc call per block per child contract.
...
export const buildOptions = ({ cliOptions }: { cliOptions: CliOptions }) => {
  ...
  return {
    ...
    // TODO: Once starknet_getEvents supports multiple addresses, increase back to 1_000
    factoryAddressCountThreshold: 1,
